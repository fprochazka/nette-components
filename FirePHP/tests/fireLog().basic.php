...
FirePHP::fireLog('Hello World'); // FirePHP::LOG
FirePHP::fireLog('Info message', FirePHP::INFO);
FirePHP::fireLog('Warn message', FirePHP::WARN);
FirePHP::fireLog('Error message', FirePHP::ERROR);
FirePHP::fireLog($arr);
